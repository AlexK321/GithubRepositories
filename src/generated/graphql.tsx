...
export type GetAllRepositoriesQueryVariables = Exact<{
...
export type GetAllRepositoriesQuery = { search: { __typename?: 'SearchResultItemConnection', repositoryCount: number, nodes?: Maybe<Array<Maybe<{ __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository', name: string, id: string, description?: Maybe<string>, owner: { __typename?: 'Organization', login: string } | { __typename?: 'User', login: string }, stargazers: { __typename?: 'StargazerConnection', totalCount: number } } | { __typename?: 'User' }>>>, pageInfo: { __typename?: 'PageInfo', endCursor?: Maybe<string>, startCursor?: Maybe<string>, hasNextPage: boolean, hasPreviousPage: boolean } } };
...
export type GetRepositoryQuery = { repository?: Maybe<{ __typename?: 'Repository', id: string, isPrivate: boolean, name: string, url: any, stargazerCount: number, description?: Maybe<string>, primaryLanguage?: Maybe<{ __typename?: 'Language', name: string }> }> };


export const GetAllRepositoriesDocument = gql`
    query getAllRepositories($searchBy: String!, $first: Int!, $after: String, $before: String, $type: SearchType!) {
  search(
    query: $searchBy
    type: $type
    first: $first
...
/**
 * __useGetAllRepositoriesQuery__
 *
 * To run a query within a React component, call `useGetAllRepositoriesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllRepositoriesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllRepositoriesQuery({
 *   variables: {
 ...
 * });
 */
export function useGetAllRepositoriesQuery(baseOptions: Apollo.QueryHookOptions<GetAllRepositoriesQuery, GetAllRepositoriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllRepositoriesQuery, GetAllRepositoriesQueryVariables>(GetAllRepositoriesDocument, options);
      }
export function useGetAllRepositoriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllRepositoriesQuery, GetAllRepositoriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllRepositoriesQuery, GetAllRepositoriesQueryVariables>(GetAllRepositoriesDocument, options);
        }
export type GetAllRepositoriesQueryHookResult = ReturnType<typeof useGetAllRepositoriesQuery>;
export type GetAllRepositoriesLazyQueryHookResult = ReturnType<typeof useGetAllRepositoriesLazyQuery>;
export type GetAllRepositoriesQueryResult = Apollo.QueryResult<GetAllRepositoriesQuery, GetAllRepositoriesQueryVariables>;
